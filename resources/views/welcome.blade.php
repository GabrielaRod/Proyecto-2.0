...
<body class="leading-normal tracking-normal text-gray-900" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="bg-right bg-cover pb-14" style="background-image:url('{{asset('logo/bg.svg')}}');">
        <!--Nav-->
        <div class="container w-full p-6 mx-auto">

            <div class="fixed flex min-h-screen items-top justify-left">
                <a href="/">
                ...
                <div
                    ...
                    @if (Route::has('login'))
                    <div class="fixed right-0 hidden px-6 py-4 top-7 sm:block">
                        @auth
            ...
            <div class="container flex flex-col flex-wrap items-center px-6 pt-24 mx-auto md:pt-48 md:flex-row">
                ...
                <div class="flex flex-col justify-center w-full overflow-y-hidden xl:w-2/5 lg:items-start">
                    <h1
                        class="my-4 text-3xl font-bold leading-tight text-center text-blue-800 md:text-5xl md:text-left slide-in-bottom-h1">
                        Bienvenido!</h1>
                    <p
                        class="mb-8 text-base leading-normal text-center md:text-2xl md:text-left slide-in-bottom-subtitle">
                        Contamos con las herramientas para brindarle seguridad a la ciudadanía!</p>

                    <p class="pb-8 font-bold text-center text-blue-400 lg:pb-6 md:text-left fade-in">Aplicación
                        disponible en:</p>
                ...
                <div class="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in">
                    <a class="text-gray-500 no-underline hover:no-underline" href="#">&copy; 2021 Creado por Gabriela
                        Rodríguez, todos los derechos reservados.</a>
                </div>
